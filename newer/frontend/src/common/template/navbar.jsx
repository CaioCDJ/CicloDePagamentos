                ...
                <ul className="nav navbar-nav">
                    <li onMouseLeave={() => this.changeOpen()}
                        ...
                        <a href="javascript:;" onClick={() => this.changeOpen()}
                            ...
                            <img src="https://avatars.githubusercontent.com/u/48222542?v=4"
...
const mapStateTopProps = state => ({user:state.auth.user})
const mapDispathToProps = dispatch => bindActionCreators({logout}, dispatch)

export default connect(mapStateTopProps,mapDispathToProps)(Navbar);
